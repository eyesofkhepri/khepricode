...
public class BookStore extends TableImpl<BookStoreRecord> {
    ...
    private static final long serialVersionUID = 427888096;

    /**
     * The reference instance of <code>db_jooq.book_store</code>
     */
    ...
    /**
     * The column <code>db_jooq.book_store.name</code>.
     */
    ...
    /**
     * Create a <code>db_jooq.book_store</code> table reference
     */
    public BookStore() {
    ...
    /**
     * Create an aliased <code>db_jooq.book_store</code> table reference
     */
